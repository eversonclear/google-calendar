class EventsController < ApplicationController
  ...
  def create
    ...
    puts event_params
    if @event.save
      SyncGoogleUserEventsWorker.perform_async(current_user.id, @event.calendar_id, @event.remote_id, 'create', event_params)
  ...
  def update
    if @event.update(event_params)
      SyncGoogleUserEventsWorker.perform_async(current_user.id, @event.calendar_id, @event.remote_id, 'update', event_params)
